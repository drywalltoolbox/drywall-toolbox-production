            ...
            damping: 20
                ...
                <ul role="list" className="mt-8 space-y-3 grow">
                  {tier.features.map(feature => <li key={feature} className="flex items-start">
                      <svg className="shrink-0 h-5 w-5 text-[#CA2C48] mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
