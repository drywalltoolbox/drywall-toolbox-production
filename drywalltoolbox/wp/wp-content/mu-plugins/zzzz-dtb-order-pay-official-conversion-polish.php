 ...
 *
 * This file is intentionally presentation-only. It targets the native
 * WooCommerce order-pay runtime and preserves gateway-owned fields,
 * payment boxes, nonces, tokenization, callbacks, and order lifecycle hooks.
 *
...
function dtb_order_pay_conversion_polish_footer(): void {
	...
	(function(){
		...
		new MutationObserver(sync).observe(document.documentElement,{childList:true,subtree:true,attributes:true,attributeFilter:['checked','class']});
	})();
	</script>
	<?php
}
