...
function dtb_support_workbench_queue_items(): array {
	return [
		...
		'unassigned'             => [ 'label' => __( 'Unassigned', 'drywall-toolbox' ),          'hint' => __( 'Needs owner assignment', 'drywall-toolbox' ),          'group' => __( 'Ownership', 'drywall-toolbox' ),   'status' => '' ],
		'urgent'                 => [ 'label' => __( 'Urgent', 'drywall-toolbox' ),              'hint' => __( 'Priority escalated tickets', 'drywall-toolbox' ),      'group' => __( 'Ownership', 'drywall-toolbox' ),   'status' => '' ],
