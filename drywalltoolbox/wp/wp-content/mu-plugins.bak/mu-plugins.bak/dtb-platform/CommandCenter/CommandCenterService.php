...
function dtb_command_center_get_dashboard_data(): array {
	...
	$model['links'] = [
		...
		'returns_review'     => add_query_arg( [ 'page' => 'dtb-returns', 'status' => 'under_review' ], $admin ),
		'returns_inspection' => add_query_arg( [ 'page' => 'dtb-returns', 'status' => 'inspection_pending' ], $admin ),
		'returns_refund'     => add_query_arg( [ 'page' => 'dtb-returns', 'status' => 'refund_pending' ], $admin ),
