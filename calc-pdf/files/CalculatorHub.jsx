...
export default function CalculatorHub() {
  ...
  // Lazy initialiser restores full summaryData (previously only activeTab was restored,
  // despite summaryData being written to localStorage on every change below).
  const [summaryData, setSummaryData] = useState(() => {
    ...
    try {
      const s = JSON.parse(localStorage.getItem('dwCalc_state') || '{}')
      return s.summaryData ? { ...defaults, ...s.summaryData } : defaults
  ...
  const handleProjectUpdate = useCallback((data) => {
    setSummaryData(prev => ({ ...prev, project: data }))
  }, [])
